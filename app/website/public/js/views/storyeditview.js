...
(function() {
  var ContentEditor, SettingsEditor, StoryEditView,
  ...
  StoryEditView = (function() {
    ...
    StoryEditView.prototype.setActiveTab = function(tab) {
      switch (tab) {
        case 'settings':
          return new SettingsEditor(this.story, this.editor);
        case 'content':
          return new ContentEditor(this.story, this.editor);
        case 'messages':
          return new MessagePane(this.story, this.editor);
        case 'history':
          return new HistoryPane(this.story, this.editor);
      }
    };
  ...
  SettingsEditor = (function() {
    ...
    SettingsEditor.name = 'SettingsEditor';
  ...
  ContentEditor = (function() {
    ...
    function ContentEditor(story, editor) {
      var _this = this;
      this.story = story;
      this.editor = editor;
    ...
    ContentEditor.prototype.createTitle = function() {
      var title,
        _this = this;
    ...
    ContentEditor.prototype.editTitle = function() {
      var editable, val,
        _this = this;
    ...
    ContentEditor.prototype.saveTitle = function() {
      var editable, val,
        _this = this;
      editable = $('#story-editor .editable.title');
    ...
    ContentEditor.prototype.cancelTitleEdit = function() {
      var editable,
        _this = this;
      editable = $('#story-editor .editable.title');
      editable.click(function() {
    ...
    ContentEditor.prototype.createParts = function() {
    ...
    ContentEditor.prototype.createPartContainer = function(part, previousElement) {
      var editable;
    ...
    ContentEditor.prototype.renderPartContent = function(editable) {
      var _this = this;
      editable.click(function() {
    ...
    ContentEditor.prototype.renderHeadingPart = function(editable) {
      var part;
      part = editable.data('part');
      return editable.html(this.makeHtml(this.getHeadingPrefix(part.size) + part.value));
    };

    ContentEditor.prototype.renderTextPart = function(editable) {
      var part;
      part = editable.data('part');
      return editable.html(this.makeHtml(part.value));
    };

    ContentEditor.prototype.renderImagePart = function(editable) {
      var alt, part, _ref;
      part = editable.data('part');
    ...
    ContentEditor.prototype.renderVideoPart = function(editable) {
    ...
    ContentEditor.prototype.editPart = function(editable) {
      var part,
        _this = this;
      part = editable.data('part');
      editable.unbind('click');
    ...
    ContentEditor.prototype.editHeadingPart = function(editable) {
    ...
    ContentEditor.prototype.editTextPart = function(editable) {
    ...
    ContentEditor.prototype.editImagePart = function(editable) {
    ...
    ContentEditor.prototype.editVideoPart = function(editable) {
      var fnAfterSave, fnUpdatePart, part, _ref,
        _this = this;
      part = editable.data('part');
    ...
    ContentEditor.prototype.savePart = function(editable, fnUpdatePart, fnAfterSave) {
    ...
    ContentEditor.prototype.cancelPartEdit = function(editable) {
      var part;
      part = editable.data('part');
      if (!part.isNew) {
        editable.removeClass('selected');
    ...
    ContentEditor.prototype.removePart = function(editable) {
      var part,
        _this = this;
      part = editable.data('part');
      if (!part.isNew) {
    ...
    ContentEditor.prototype.addSection = function(previous) {
    ...
    ContentEditor.prototype.makeHtml = function(markdown) {
      if (markdown) {
    ...
    ContentEditor.prototype.createForm = function(parent, html) {
      var _this = this;
      parent.html(html);
    ...
    ContentEditor.prototype.getHeadingPrefix = function(size) {
      switch (size) {
        case 'H1':
          return '#';
        case 'H2':
